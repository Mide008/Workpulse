...
const statusConfig: Record<string, { label: string; color: string; badge: BadgeVariant }> = {
  not_started: { label: 'Not Started', color: 'text-slate-400', badge: 'default' },
    ...
    <div className="max-w-5xl mx-auto animate-fade-in">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <div className="bg-slate-900/80 border border-white/[0.06] rounded-2xl p-6 text-center">
            ...
            <h1 className="text-xl font-bold text-white mb-1">{member.full_name}</h1>
            <p className="text-slate-400 text-sm mb-3">{member.job_title ?? 'Team member'}</p>
          ...
          {/* Stats */}
          <div className="bg-slate-900/80 border border-white/[0.06] rounded-2xl p-5 space-y-3">
          ...
          {latestKpi && (
            <div className="bg-slate-900/80 border border-white/[0.06] rounded-2xl p-5">
              <h3 className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-4">KPI Score</h3>
        ...
        <div className="lg:col-span-2">
          <div className="bg-slate-900/80 border border-white/[0.06] rounded-2xl overflow-hidden">
            <div className="px-6 py-4 border-b border-white/[0.06]">
              <h2 className="font-semibold text-white">Tasks ({total})</h2>
            </div>
