    ...
    <div className="min-h-screen bg-[var(--bg-surface)] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-[var(--bg-surface)]/60 border border-[var(--border)][0.06] rounded-2xl p-8">
          ...
          <p className="text-[var(--text-secondary)] text-sm mb-6">Start your free WorkPulse workspace</p>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              <label className="text-sm text-[var(--text-secondary)] block mb-1.5">Work email</label>
